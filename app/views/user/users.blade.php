	...
	<div class="col-lg-5 col-md-9 col-sm-9 hidden-xs">
		...
		<div class="btn-group btn-group-justified" role="group">
			<div class="btn-group" role="group">
				<a href="{{ route('usershome') }}"><button type="button" class="btn filter-effect btn-edit btn-default-edit active">My FoodFire</button></a>
			</div>
			<div class="btn-group" role="group">
...
<div class="container-fluid">
	<div class="row">
		<h1 style="font-size:20px; margin-left:10px"><i class="fa fa-user"></i> My FoodFire</h1>
		<hr style="margin-left:0px; margin-top:5px; width:25%">
		<hr style="margin-right:0px; margin-top:19px">
	</div>
</div>
@stop
